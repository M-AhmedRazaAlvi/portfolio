...
export default function DailyAyahPrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - Daily Ayah</title>
        <meta
          name="description"
          content="Privacy Policy for Daily Ayah mobile application"
        />
      </Head>
      <div className="group/spotlight relative">
        <div
          ...
          style={{
            background:
              "radial-gradient(800px at 578px 200px, rgba(29, 78, 216, 0.15), transparent 80%)",
          }}
        ></div>
        <div className="mx-auto min-h-screen max-w-3xl px-6 py-12 font-sans md:px-12 md:py-16">
          <header className="mb-8">
            ...
            <p className="mt-4 text-slate-400">Daily Ayah Mobile Application</p>
          </header>
          ...
          <main className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-slate-400">
              ...
              fahadsaleem303@gmail.com and they will respond in a reasonable
              time.
            </p>
            ...
            <p className="text-slate-400 mt-4">
              ...
              please contact the Service Provider (fahadsaleem303@gmail.com) so
            ...
            <p className="text-slate-400 mt-4">
              This privacy policy is effective as of 2025-10-10
            </p>
            ...
            <p className="text-slate-400">
              ...
              <a
                href="mailto:fahadsaleem303@gmail.com"
                className="text-teal-300 hover:text-teal-200 transition-colors"
              >
                fahadsaleem303@gmail.com
              </a>
              .
            </p>
